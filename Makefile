...
TWEAK_NAME = warface1502

warface1502_CFLAGS = -fobjc-arc
warface1502_CCFLAGS = -std=c++11 -fno-rtti -fno-exceptions -DNDEBUG

ifeq ($(IGNORE_WARNINGS),1)
  warface1502_CFLAGS += -w
  warface1502_CCFLAGS += -w
endif


warface1502_FILES = Tweak.xm $(MENU_SRC) $(KITTYMEMORY_SRC) $(SCLALERTVIEW_SRC)

warface1502_LIBRARIES += substrate

warface1502_FRAMEWORKS = $(PROJ_COMMON_FRAMEWORKS)
# GO_EASY_ON_ME = 1
